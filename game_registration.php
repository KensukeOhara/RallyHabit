<?php
    ...
    $registor = $_SESSION['user_name']; //登録者
    ...
    //ラリーの登録
    $sql = 'INSERT INTO `game_tb`(`game_title`, `registor`, `player_id1`, `player_id2`, `token`, `service_flag`, `courses`) VALUES ("'.$game_title .'", "'.$registor .'", "' . $player_id1. '", "' . $player_id2 . '", "'. $token . '", "'. $service_flag_num .'", "'. $rally_array .'")';
    $dbh->exec($sql); //SQLの実行
